...
from ppm.utils import parse_args, add_outcome_labels, prepare_bpi15_data, prepare_data, get_model_config
...
def main(training_config: dict):
    ...
    # prepare_bpi15_data may return either (train, test) or (train, test, train_timestamps, test_timestamps)
