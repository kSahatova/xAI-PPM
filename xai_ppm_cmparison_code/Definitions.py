...
logs_dir = r'C:\Users\sahat\OneDrive - KU Leuven\Research\PPM&xAI\data\processed_benchmark_event_logs'
...
BPIC2017_datasets = ['BPIC17_O_Accepted', 'BPIC17_O_Cancelled', 'BPIC17_O_Refused']
for d in BPIC2017_datasets:
    filename[d] = os.path.join(logs_dir, '%s.csv' % (d))

    case_id_col[d] = "Case ID"
    ...
    dynamic_cat_cols[d] = [activity_col[d], resource_col[d], 'Action', 'CreditScore', 'EventOrigin',
                           ...
                           "Accepted", "Selected"]
    static_cat_cols[d] = ['ApplicationType', 'LoanGoal']
    dynamic_num_cols[d] = ['FirstWithdrawalAmount', 'MonthlyCost', 'NumberOfTerms', 'OfferedAmount',
                           ...
                           "weekday", "hour",
                           "open_cases"]
    static_num_cols[d] = ['RequestedAmount']
